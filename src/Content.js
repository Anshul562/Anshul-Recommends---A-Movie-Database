            ...
            <div className="row_posters" style={{height:'max-content'}} >
                ...
                {photos.map((photo)=>(
                    <a href={base_url+photo.file_path} key={photo.file_path}>
                        ...
                        src={base_url+"/w220_and_h330_face"+photo.file_path} srcSet={base_url+"/w220_and_h330_face"+photo.file_path+" 1x,"+base_url+"/w440_and_h660_face"+photo.file_path+" 2x"} alt={photo.name}/>
